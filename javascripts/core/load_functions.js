...
function setChallengeDisplay(){
        ...
        document.getElementById("infPowEffectPowerDiv").innerHTML = ((tmp.ngmX >= 2 || tmp.ngC) && tmp.ngmX < 6) ? "which is raised to the power of <span id='infPowEffectPower' style='font-size:35px; color: black'></span>, and then t" : "which is t"
